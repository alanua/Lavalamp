...
enum SceneId : uint8_t {
  ...
  SCENE_ID_AURORA_TUBE = 6,
  SCENE_ID_INNER_SWIRL = 7,
  SCENE_ID_BUBBLES_VOLUME = 8,
  SCENE_ID_RING_RIPPLES = 9,
  SCENE_ID_RING_RIPPLES_RAINBOW = 10,
  SCENE_ID_BOTTOM_RAYS = 11,
  SCENE_ID_RISING_BANDS = 12,
  SCENE_ID_HELICAL_PLASMA = 13,
  SCENE_ID_NOISE_WAVES_TUBE = 14,
  SCENE_ID_CELL_MEMBRANE_FLOW = 15,
  SCENE_ID_CROSS_BANDS_TUBE = 16
};
